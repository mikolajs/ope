...
class MainSn extends BaseSnippet {
  ...
  def newMessage():CssSel = {
    ...
    val teacherHead = if (mapTeachers.nonEmpty) mapTeachers.head._2 else ""
  ...
  private def getTeachers: List[User] = {

...
import eu.brosbit.ope.lib.{Formater, ZeroObjectId}
import eu.brosbit.ope.model.{LessonCourse, MessageItem, MessagesWork, Work}
import eu.brosbit.ope.snippet.WorkCommon
import eu.brosbit.ope.snippet.view.BaseSnippet

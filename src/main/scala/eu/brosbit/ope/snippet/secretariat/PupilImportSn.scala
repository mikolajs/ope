...
package eu.brosbit.ope.snippet.secretariat

import _root_.net.liftweb.util._
import _root_.net.liftweb.http.{FileParamHolder, S, SHtml, SessionVar}
import _root_.net.liftweb.common._
import _root_.net.liftweb.mapper.By
import Helpers._
import eu.brosbit.ope.model._
import eu.brosbit.ope.lib.{Formater, Validator}
...
class PupilImportSn {
  ...
  val classMod: ClassModel = ClassModel.find(By(ClassModel.id, ClassChoose.get)).getOrElse(ClassModel.create)
